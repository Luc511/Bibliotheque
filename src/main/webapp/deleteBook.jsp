...
<div class="container py-5">
    <div class="jumbotron text-center">
        <h1 class="display-4">Bibliothèque - Supprimer un livre</h1>
    </div>
    ...
    <%
        ...
        if (isbn != null) {
            boolean result = Queries.deleteBook(Queries.findByISBN(isbn), (User) request.getSession().getAttribute("loggedUser"));
            if (result) {
    %>
    <div class="alert alert-success mt-4">Le livre a été supprimé avec succès</div>
    <%
    } else {
    %>
    <div class="alert alert-danger mt-4">Il y a eu un problème lors de la suppression du livre </div>
    <%
            }
        }
    %>
